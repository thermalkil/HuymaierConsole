...
function Initialize-HcPlatformPresentationConfig {
    ...
    try{$script:Config.PlatformModelBrightness=[math]::Max(0,[math]::Min(200,[int]$script:Config.PlatformModelBrightness))}catch{$script:Config.PlatformModelBrightness=135}
}
