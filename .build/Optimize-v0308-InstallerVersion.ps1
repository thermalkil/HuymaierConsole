...
# HUYMAIER_V0308_INSTALLER_VERSION_TRANSFORM_V2
...
if($installer -notmatch 'HUYMAIER_V0308_ARTWORK_INSTALLER_CACHE_V2'){
    $anchor="            'HuymaierArtworkWorker.ps1',"
    $insert=@($anchor,"            # HUYMAIER_V0308_ARTWORK_INSTALLER_CACHE_V2","            'HuymaierArtworkSources.ps1',","            'HuymaierArtworkSourcesTgdbSchema.ps1',","            'HuymaierArtworkManagement.ps1',") -join $lf
...
if($core -notmatch 'HUYMAIER_V0308_ARTWORK_INSTALLER_REQUIRED_V2'){
    $anchor="        'HuymaierBootstrap.ps1','HuymaierConsole.ps1','HuymaierGameBar.ps1',"
    $insert="        'HuymaierBootstrap.ps1','HuymaierConsole.ps1','HuymaierArtworkSources.ps1','HuymaierArtworkSourcesTgdbSchema.ps1','HuymaierArtworkManagement.ps1','HuymaierGameBar.ps1', # HUYMAIER_V0308_ARTWORK_INSTALLER_REQUIRED_V2"
