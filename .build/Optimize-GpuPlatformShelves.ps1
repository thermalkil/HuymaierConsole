...
$shaderV5Anchor='    static const char* HcShelfShaderSource = R"HLSL('+$nl+'    // HUYMAIER_D3D11_SHELF_SHADER_V5_BALANCED_COLOR_PRESERVING_UI_PBR'
$shaderV6Anchor='    static const char* HcShelfShaderSource = R"HLSL('+$nl+'    // HUYMAIER_D3D11_SHELF_SHADER_V6_VERTEX_COLOR_UI_PBR'+$nl+'    // HUYMAIER_D3D11_SHELF_SHADER_V5_BALANCED_COLOR_PRESERVING_UI_PBR'
Replace-HcGpuExact $assetHeaderPath $shaderV5Anchor $shaderV6Anchor 'shader v6 marker'
...
$baseRgbV5='        float3 baseRgb=max(baseTextureLinear*BaseColor.rgb,0.0);'
$baseRgbV6='        float4 vertexColor=saturate(i.color);'+$nl+'        float3 baseRgb=max(baseTextureLinear*BaseColor.rgb*vertexColor.rgb,0.0);'
Replace-HcGpuExact $assetHeaderPath $baseRgbV5 $baseRgbV6 'shader vertex color base multiplication'
