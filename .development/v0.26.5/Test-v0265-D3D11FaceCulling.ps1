...
foreach($n in @('CacheVersion = 3','Determinant3x3','bool mirrored','ix[i + 2]','ix[i + 1]')){if($c.IndexOf($n,[StringComparison]::Ordinal)-lt0){throw "Mirrored-node winding contract missing: $n"}}
