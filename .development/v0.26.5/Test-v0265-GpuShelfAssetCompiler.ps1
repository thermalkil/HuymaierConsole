...
foreach($n in @('HUYMAIER_GPU_SHELF_ASSET_CACHE_V3','DefaultShelfTextureSize = 512','IsCacheCurrent','EnsureCompiled','DecodePixelWidth','DecodePixelHeight','TEXCOORD_0','EmissiveTexture','MetallicRoughnessTexture','NormalTexture','OcclusionTexture','NormalScale','OcclusionStrength','LastWriteTimeUtc.Ticks')){if($compilerText.IndexOf($n,[StringComparison]::Ordinal)-lt0){throw "GPU shelf compiler contract missing: $n"}}
